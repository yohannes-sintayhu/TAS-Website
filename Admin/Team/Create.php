...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($uploadOk == 1) {
        ...
        if (move_uploaded_file($_FILES['teamFile']['tmp_name'], $targetFile)) {
            ...
            $sql = "INSERT INTO team (name, File_Path, position, role) VALUES (?, ?, ?, ?)";
            $stmt = $connection->prepare($sql);
            $stmt->bind_param("ssss", $name, $File_Path, $position, $role);
            ...
            if ($stmt->execute()) {
                ...
                $stmt->close();
                $connection->close();
                $successMessage = 'Team submitted successfully.';
            } else {
            ...
            <section class="col-xl-10 offset-xl-1 connectedSortable" style="padding-top:1rem;">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title">
                            <i class="fa fa-plus"></i> Create New Team Memeber
                        </h3>
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <div class="row">
                                <div class="form-group col-xl-12">
                                    ...
                                    <span class="text-danger"><?php echo isset($errors['position']) ? $errors['position'] : ''; ?></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xl-12">
                                    ...
                                    <span class="text-danger"><?php echo isset($errors['role']) ? $errors['role'] : ''; ?></span>
                                </div>
                            </div>
                            <div class="row" id="projectFile">
                                <div class="form-group col-lg-8">
                                    <label for="teamFile">Project Picture <i class="text-danger">*</i></label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input name="teamFile" type="file" class="custom-file-input" id="exampleInputFile" required>
