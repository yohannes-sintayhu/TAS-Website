<?php
    ...
    if (isset($_GET['action']) && $_GET['action'] === 'get_data') {
        ...
        $sql = "SELECT created_at, name, email, phone, message, id  FROM quotes"; 
        ...
        foreach ($data as &$entry) {
            ...
            $entry['phone'] = mb_convert_encoding($entry['phone'], 'UTF-8');
...
<div class="content-wrapper">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#QuoteTable tbody').on('click', '.delete-action', function (e) {
                e.preventDefault();
                var id = $(this).data('id');
                console.log(id);
                        ...
                        success: function (response) {
                            try {
                                ...
                                if (result.success) {
                                    ...
                                    $('#QuoteTable').DataTable().ajax.reload(); // Refresh the table
                                } else {
