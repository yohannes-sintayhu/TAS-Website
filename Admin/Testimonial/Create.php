...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($uploadOk == 1) {
        ...
        if (move_uploaded_file($_FILES['testimonialFile']['tmp_name'], $targetFile)) {
            ...
            $sql = "INSERT INTO testimonial (name, File_Path, designation, testimonial) VALUES (?, ?, ?, ?)";
            $stmt = $connection->prepare($sql);
            $stmt->bind_param("ssss", $name, $File_Path, $designation, $testimonial);
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <div class="row">
                                <div class="form-group col-xl-12">
                                    ...
                                    <span class="text-danger"><?php echo isset($errors['designation']) ? $errors['designation'] : ''; ?></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xl-12">
                                    <label for="testimonial">Testimonial  <i class="text-danger">*</i></label>
                                    <textarea name="testimonial" class="form-control" id="testimonial" rows="4" required></textarea>
                                    <span id="testimonial-error" class="text-danger"><?php echo isset($errors['testimonial']) ? $errors['testimonial'] : ''; ?></span>
                                </div>
                            </div>
                            <div class="row" id="projectFile">
                                <div class="form-group col-lg-8">
                                    <label for="testimonialFile">Project Picture <i class="text-danger">*</i></label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input name="testimonialFile" type="file" class="custom-file-input" id="exampleInputFile" required>
