...
if (isset($_GET['action']) && $_GET['action'] === 'get_data') {
    ...
    $sql = "SELECT name, designation, testimonial, File_Path, id , status FROM testimonial"; 
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <a href="create.php" class="btn btn-outline-primary btn-sm ">Create Testimonial</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $('#testimonialTable tbody').on('click', '.delete-action', function (e) {
    e.preventDefault();
    var id = $(this).data('id');
    console.log(id);
            ...
            success: function (response) {
                try {
                    ...
                    if (result.success) {
                        ...
                        $('#testimonialTable').DataTable().ajax.reload(); // Refresh the table
    ...
    $('#testimonialTable tbody').on('click', '.deactivate-action', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
    ...
    $('#testimonialTable tbody').on('click', '.activate-action', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
        // Confirm before deactivation
