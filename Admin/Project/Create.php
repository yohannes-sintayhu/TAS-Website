...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($uploadOk == 1) {
        ...
        if (move_uploaded_file($_FILES['projectFile']['tmp_name'], $targetFile)) {
            ...
            $sql = "INSERT INTO project (project_catagory, File_Path, Project_name, Description) VALUES (?, ?, ?, ?)";
            $stmt = $connection->prepare($sql);
            $stmt->bind_param("ssss", $project_catagory, $File_Path, $Project_name, $ProjectDescription);
            ...
            if ($stmt->execute()) {
                ...
                $errorMessages[] = 'Error occurred while submitting the project.';
            }
        } else {
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            <div class="row">
                                <div class="form-group col-xl-12">
                                    ...
                                    <span class="text-danger"><?php echo isset($errors['Project_name']) ? $errors['Project_name'] : ''; ?></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xl-12">
                                    ...
                                    <select name="project_catagory" class="form-control" id="project_catagory" required>
                                        ...
                                        <option value="residential_international">International Residential Projects</option>
                                        <option value="residential_local">Local Residential Projects</option>
                                    </select>
                                    <span class="text-danger"><?php echo isset($errors['project_catagory']) ? $errors['project_catagory'] : ''; ?></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xl-12">
                                    <label for="ProjectDescription">Project Description <i class="text-danger">*</i></label>
                                    <textarea name="ProjectDescription" class="form-control" id="ProjectDescription" rows="4" required></textarea>
                                    <span id="ProjectDescription-error" class="text-danger"><?php echo isset($errors['ProjectDescription']) ? $errors['ProjectDescription'] : ''; ?></span>
                                </div>
                            </div>
                            <div class="row" id="projectFile">
                                <div class="form-group col-lg-8">
                                    <label for="projectFile">Project Picture <i class="text-danger">*</i></label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input name="projectFile" type="file" class="custom-file-input" id="exampleInputFile" required>
