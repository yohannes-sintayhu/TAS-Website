...
if (isset($_GET['action']) && $_GET['action'] === 'get_data') {
    ...
    $sql = "SELECT Project_name, project_catagory, Description, File_Path, id , status FROM project"; 
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <a href="create.php" class="btn btn-outline-primary btn-sm ">Create Project</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $('#projectTable tbody').on('click', '.delete-action', function (e) {
    e.preventDefault();
    var id = $(this).data('id');
    console.log(id);
            ...
            success: function (response) {
                try {
                    ...
                    if (result.success) {
                        ...
                        $('#projectTable').DataTable().ajax.reload(); // Refresh the table
    ...
    $('#projectTable tbody').on('click', '.deactivate-action', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
    ...
    $('#projectTable tbody').on('click', '.activate-action', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
        // Confirm before deactivation
